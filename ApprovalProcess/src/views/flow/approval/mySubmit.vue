  ...
  <div>
    ...
    <div>
      <el-form :inline="true" :model="search" class="demo-form-inline">
        ...
        <el-form-item label="">
          <el-button type="primary" icon="el-icon-search" @click="showMylist()">搜索</el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table :data="tableData" style="width: 100%" border v-loading="fullscreenLoading" element-loading-text="拼命加载中">
      ...
      <el-table-column label="操作" fixed="right" width="120">
        <template slot-scope="scope"> 
          <el-button type="danger" icon="el-icon-star-on" @click="detailMessage(scope.$index, scope.row)">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
          <div class="block">
