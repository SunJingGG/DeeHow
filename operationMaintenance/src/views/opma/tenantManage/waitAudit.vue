  ...
  <div>
    <div>
      <el-form :inline="true" :model="search" class="demo-form-inline">
        ...
        <!-- <el-form-item label="">
          <el-input v-model="search.deviceAppearance" placeholder="故障现象"></el-input>
        </el-form-item> -->
        <el-form-item>
    ...
    <div>
      <el-table :data="listData" v-loading="fullscreenLoading" element-loading-text="拼命加载中" border>
        ...
        <el-table-column prop="createTime" label="申请时间" min-width="180"></el-table-column>
...
<script>
import { readRegisterPage, updateRegister } from "@/api/opma";
export default {
  data() {
    return {
