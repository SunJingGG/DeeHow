        ...
        <div class="sview" style="overflow:auto">
          <div>
            ...
            <div v-show="auditIO" class="clearfix">
              {{this.auditObj.categoryId}}
              <el-button type="primary" icon="el-icon-edit" class="pull-right" circle></el-button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.propty.publicProperty = this.auditObj.public;
      this.propty.specialProperty = this.auditObj.special;
      console.log(this.propty)
      // propty: {
      //   publicProperty: {},
      //   specialProperty: []
      // }
