    ...
    <div>
      ...
      <div class="container" style="padding-top:10px">
        <div class="row" style="padding-top:6px">
          ...
          <div class="col-md-6 .col-sm-6">
            <nav class="navbar" role="navigation" style="line-height:50px;float:right">
      ...
      <div class="loginBox">
        <div style="line-height:40px">
          ...
          <a href="../LoingRegisterAndHome/index.html#/register/regHome" class="btn resbtn" style="margin-left:10px">注册</a>
        </div>
      </div>
    </div>
  </div>
