  ...
  <div>
    ...
    <div v-else-if="detailIO==2">
      <div class="into">
        ...
        <p>5、确认导入</p>
        <div>
          <el-upload class="upload-demo" drag  :action="DEEHOWBASEURL+'/deehow-ELIBM-Web/manufacturersAndSuppliers/import/look/manufacturers'"  :on-success="onSuccess">
...
export default {
  ...
  methods: {
    ...
    download() {
      let str = this.DEEHOWBASEURL + "/deehow-ELIBM-Web/manufacturersAndSuppliers/export/format/manufacturers";
