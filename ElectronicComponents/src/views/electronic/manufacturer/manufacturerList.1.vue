  ...
  <div>
    ...
    <el-dialog :title="search.type=='1'?'生产厂家':'客户'" :visible.sync="dialogFormVisible" width="55%">
      <el-form :inline="true" :model="form" ref="form" :rules="rules">
        ...
        <el-form-item label="国别" :label-width="formLabelWidth" prop="differentCountries">
...
export default {
  ...
  methods: {
    ...
    download() {
      let str = this.DEEHOWBASEURL + "/deehow-CMS-Web/public/excel2007/import?titleNames=";
      let arr=['公司名称','公司简称','国别','备注'];
      arr.forEach((v,i)=>{
        if(i<arr.length-1){
          str+= v+'&titleNames='
        }else{
