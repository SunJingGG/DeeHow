 ...
 * 审批意见
 */
export function selectApproveComment(data) {
  
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/elib/process_approve/select_approve_comment',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
 ...
 * 审批意见
 */
export function readLookTask(data) {
  
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/elib/process_approve/select_look_task',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
...
export function updateReadState(data) {
  ...
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/elib/process_approve/update_read_state',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
 ...
 * 全部审批
 */
export function readQueryMonitor(data) {
  
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/elib/process_monitor/query_monitor',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
 ...
 * 审批历史
 */
export function readProcessHistory(data) {
 ...
 * 待办审批
 */
export function readQueryProcessTask(data) {
  
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/elib/process_approve/query_process_task',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
 ...
 * 申请新编码提交接口
 */
export function ApplyNewNum(data) {
  
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/process_form_material_code/update',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
 ...
 * 申请新编码详情接口
 */
export function ApplyNewNumDetail(data) {
  
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/process_form_material_code/read/list',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
 ...
 * 打回列表详情详情接口
 */
export function returnNewNumDetail(data) {
  
  const params = JSON.stringify(data);
  return request({
      url: '/deehow-BPM-Web/elib/process_approve/query_disagree_task',
      method: 'post',
      data: params,
      headers: {
        'content-type': 'application/json'
